package com.example.chen.ls4000.task;
...
import com.example.chen.ls4000.utils.BluetoothConnector;
...
public class BlueConnectTask extends AsyncTask<BluetoothDevice, Void, BluetoothSocket> {
    ...
    public void setBlueConnectListener(AdapterView.OnItemClickListener listener) {
        mListener = (BlueConnectListener) listener;
    }
