...
public class Location_Activity extends CheckPermissionsActivity
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setTitle(getString(R.string.string71));
		...
		public void onLocationChanged(AMapLocation location) {
			if (null != location) {
				...
				if(location.getErrorCode() == 0){
					...
					sb.append(getString(R.string.string220) + location.getErrorCode() + "\n");
				...
				tvResult.setText(getString(R.string.string56)+"，loc is null");
			}
		}
	};
