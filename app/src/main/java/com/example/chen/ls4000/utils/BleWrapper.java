...
public class BleWrapper {
    ...
    public BleWrapper(Context context, BleWrapperUiCallbacks callback) {
    ...
    //private String address = "00:0E:17:00:00:00"; //"20:16:09:26:81:80"; // <==应填写蓝牙串口模块的蓝牙地址。
...
//
//        String address = "00:0E:17:00:00:00"; //"20:16:09:26:81:80"; // <==应填写蓝牙串口模块的蓝牙地址。
//
//        OutputStream outStream = null;
//        BA = BluetoothAdapter.getDefaultAdapter();
//        BluetoothDevice device = BA.getRemoteDevice(address);
//        try {
//            btSocket = device.createRfcommSocketToServiceRecord(UUID.fromString("0000ffe1-0000-1000-8000-00805f9b34fb"));//("00001101-0000-1000-8000-00805F9B34FB"));
//            //btSocket.connect();
    ...
    private final BluetoothGattCallback mBleCallback = new BluetoothGattCallback() {
        ...
        public void onServicesDiscovered(BluetoothGatt gatt, int status) {
            if (status == BluetoothGatt.GATT_SUCCESS) {
                ...
                Log.e("get support service", "do it");
